...
public final class SecChainVerifier: ReceiptChainVerifier, Sendable {
    ...
    func verify(
        ...
        //certificates.append(contentsOf: rootSecCertificates)
        ...
        for p in policy {
            ...
            } else if case .validationTime(let data) = p {
