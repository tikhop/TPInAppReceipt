...
public struct ReceiptValidator: Sendable {
    internal let verifiers: [any ReceiptVerifier]
    ...
    public func validate(_ receipt: ReceiptValidatable) async -> VerificationResult {
...
public extension ReceiptValidator {
