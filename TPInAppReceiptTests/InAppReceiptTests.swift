...
class InAppReceiptTests: XCTestCase {
    ...
    func testNoOpenssl()
    {
        ...
        let receipt = InAppReceipt(pkcs7: p, payload: InAppReceiptPayload(noOpenSslData: p.extractASN1Data()))
...
fileprivate extension InAppReceiptPayload
{
    ...
    {
        self.init(bundleIdentifier: "test-bundle-identifier", appVersion: "", originalAppVersion: "", purchases: purchases, expirationDate: "", bundleIdentifierData: Data(), opaqueValue: Data(), receiptHash: Data(), receiptCreationDate: "")
    }
}
